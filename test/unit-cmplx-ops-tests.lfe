...
(deftest conj
  ...
  (is-equal #(complex 0 -5) (complex:conj (unit-cmplx-tests:c7))))
...
(deftest modsq
  ...
  (is-equal #(complex 25 0) (complex:modsq (unit-cmplx-tests:c7))))
...
(deftest inv
  ...
  (is-equal #(complex 0.2 -0.4) (complex:inv (unit-cmplx-tests:c2)))
